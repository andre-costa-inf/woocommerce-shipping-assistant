...
Description: Adiciona o status Enviado, email automático para o status enviado e shortcode [woocommerce-status-checker] que pode ser adicionado na área de cliente do seu tema para acompanhamento do pedido.
Version: 1.0.2
Author: Andre Costa
